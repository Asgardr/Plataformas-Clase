	...
	public void ActivateDoor(GameObject other)
	{
		...
		if (other.tag == "Player")
		{
            ...
            if (m_GameManager != null)
            {
				...
				m_GameManager.ActivateDoor(m_DoorColorToActivate, true);
				...
				spawnPoint.name = "SpawnPoint" + m_DoorColorToActivate.ToString();
				...
				m_GameManager.SetCurrentSpawnPoint(spawnPoint.transform);
